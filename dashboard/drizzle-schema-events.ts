...
// ============================================================================
// FILE: src/lib/db/schema.ts (or schema/events.ts)
//
...
import { budgetCategories } from '../src/db/libsql-schemas/budgetCategories'
import { deadlines } from '../src/db/libsql-schemas/deadlines'
import { participants } from '../src/db/libsql-schemas/participants' // Import other tables
import { services } from '../src/db/libsql-schemas/services'
import { speakers } from '../src/db/libsql-schemas/speakers'
import { sponsors } from '../src/db/libsql-schemas/sponsors'
...
5. Or use migrate() programmatically:
