  ...
  try {
    ...
    const participantsList = [
      // Tech Summit participants
      {
        ...
        firstName: 'Mario',
        lastName: 'Rossi',
        registrationDate: new Date('2024-12-01T09:15:00'),
      ...
      },
      {
        ...
        firstName: 'Laura',
        lastName: 'Bianchi',
        registrationDate: new Date('2024-12-01T09:18:00'),
      ...
      },
      {
        ...
        firstName: 'Giovanni',
        lastName: 'Verdi',
        registrationDate: new Date('2024-12-01T10:05:00'),
      ...
      },
      {
        ...
        firstName: 'Francesca',
        lastName: 'Neri',
        registrationDate: new Date('2024-12-01T10:22:00'),
      ...
      },
      {
        ...
        lastName: 'Russo',
        registrationDate: new Date('2024-12-01T11:05:00'),
      ...
      // Workshop AI participants
      {
        ...
        firstName: 'Sofia',
        lastName: 'Colombo',
        registrationDate: new Date('2024-12-02T09:00:00'),
        checkinTime: new Date('2024-12-02T09:45:00'),
      ...
      },
      {
        ...
        firstName: 'Marco',
        lastName: 'Ferrari',
        registrationDate: new Date('2024-12-02T09:10:00'),
        checkinTime: new Date('2024-12-02T09:40:00'),
      ...
      },
      {
        ...
        firstName: 'Giulia',
        lastName: 'Romano',
        registrationDate: new Date('2024-12-02T09:20:00'),
      ...
      },
      {
        ...
        firstName: 'Luca',
        lastName: 'Marino',
        registrationDate: new Date('2024-12-02T09:30:00'),
        checkinTime: new Date('2024-12-02T09:55:00'),
      ...
      // Marketing Conference participants
      {
        ...
        firstName: 'Elena',
        lastName: 'Gallo',
        registrationDate: new Date('2024-12-05T10:00:00'),
