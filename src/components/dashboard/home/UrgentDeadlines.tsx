    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-gray-900">Scadenze Urgenti</h2>
        </div>
        <div className="text-center py-8">
          <Clock className="w-12 h-12 text-gray-300 mx-auto mb-3" />
          <p className="text-sm text-gray-500">Nessuna scadenza urgente al momento</p>
          <p className="text-xs text-gray-400 mt-1">Ottimo lavoro! 🎉</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      {upcomingDeadlines.length > 0 && (
        <div>
          <h3 className="text-sm font-semibold text-gray-700 mb-3">Prossime Scadenze</h3>
          <div className="space-y-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center space-x-3 text-xs text-gray-500">
          ...
          {deadline.category && (
            <>
              <span className="text-gray-300">•</span>
              <span className="bg-gray-100 px-1.5 py-0.5 rounded">{deadline.category}</span>
            </>
          )}
        </div>
      </div>
