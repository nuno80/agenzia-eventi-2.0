// src/components/landing/ServerFAQSection.tsx
...
const ServerFAQSection = () => {
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Domande Frequenti</h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              <div className="px-6 pb-6 text-slate-600 border-t border-slate-200 pt-4">{faq.a}</div>
            </details>
          ))}
        </div>
      </div>
...
export default ServerFAQSection
